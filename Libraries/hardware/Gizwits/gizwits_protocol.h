...
#define pump_LEN                           1
#define curtain_down_BYTEOFFSET                    0
#define curtain_down_BITOFFSET                     1
#define curtain_down_LEN                           1
#define curtain_up_BYTEOFFSET                    0
#define curtain_up_BITOFFSET                     2
#define curtain_up_LEN                           1
#define default_BYTEOFFSET                    0
#define default_BITOFFSET                     3
...
typedef struct {
  bool valuepump;
  bool valuecurtain_down;
  bool valuecurtain_up;
  bool valuedefault;
...
typedef struct {
  uint8_t flagpump:1;
  uint8_t flagcurtain_down:1;
  uint8_t flagcurtain_up:1;
  uint8_t flagdefault:1;
