...
* @{
*/
#define PRODUCT_KEY "392cb587ec584290b25400ddb0118c0a"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "4aa762e3a04947389ce23944144dcbc8"
...
#define fan_MIN                           0
#define fan_MAX                           3
#define BH1750_RATIO                         1
#define BH1750_ADDITION                      0
#define BH1750_MIN                           0
#define BH1750_MAX                           100
#define CO2_RATIO                         1
...
#define humi_MAX                           100
#define soil_RATIO                         1
#define soil_ADDITION                      0
#define soil_MIN                           0
#define soil_MAX                           100
#define distant_RATIO                         1
#define distant_ADDITION                      0
#define distant_MIN                           0
#define distant_MAX                           50
/**@} */
...
{                                                   
    ...
    CMD_CONNECT_M2M_BACK            = 0x2F,         ///< Protocolï¼šfor Virtualization
    ACK_CONNECT_M2M_BACK            = 0x30,         ///< Protocolï¼šfor Virtualization

    CMD_UPLOAD_DATA                 = 0x31,         ///< Protocolï¼šfor Virtualization
    ACK_UPLOAD_DATA                 = 0x32,         ///< Protocolï¼šfor Virtualization

    CMD_UPLOAD_DATA_BACK            = 0x33,         ///< Protocolï¼šfor Virtualization
    ACK_UPLOAD_DATA_BACK            = 0x34,         ///< Protocolï¼šfor Virtualization

    CMD_DISCONNECT_M2M              = 0x35,         ///< Protocolï¼šfor Virtualization
    ACK_DISCONNECT_M2M              = 0x36,         ///< Protocolï¼šfor Virtualization

    CMD_DISCONNECT_M2M_BACK         = 0x37,         ///< Protocolï¼šfor Virtualization
    ACK_DISCONNECT_M2M_BACK         = 0x38,         ///< Protocolï¼šfor Virtualization

    CMD_RESET_SIMULATOR             = 0x39,         ///< Protocolï¼šfor Virtualization
    ACK_RESET_SIMULATOR             = 0x3A,         ///< Protocolï¼šfor Virtualization

    CMD_RESET_SIMULATOR_BACK        = 0x3B,         ///< Protocolï¼šfor Virtualization
    ACK_RESET_SIMULATOR_BACK        = 0x3C,         ///< Protocolï¼šfor Virtualization
} PROTOCOL_CMDTYPE;                                                                                  
