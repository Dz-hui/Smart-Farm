...
*@FilePath: ??¾¶·Ö¸ô???Ìæ??ÐÂ½¨ÎÄ¼þ¼Ð??¾¶·Ö¸ô???Ìæ??Libraries??¾¶·Ö¸ô???Ìæ??hardware??¾¶·Ö¸ô???Ìæ??pwm.h
*@Drscription: 
***********************************************************************/
#ifndef __PWM__H
#define __PWM__H
...
#define FAN_QTMR_PORT               TMR4     // FAN
#define FAN_QTMR_CHANNLE            kQTMR_Channel_3

#define QTMR_PWM_FREQ               20000  //20KHz
